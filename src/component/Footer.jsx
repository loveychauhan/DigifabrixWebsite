...
const Footer = () => {
  return (
    <footer className="pt-16 bg-slate-900 pb-8 border-t border-slate-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-slate-100 text-[12px] leading-relaxed">
          ...
          <div>
            <h4 className="font-bold text-slate-200 mb-4">Solutions</h4>
            <ul className="space-y-2 text-sm text-slate-100">
              ...
              <li>
                <Link
                  href="/solutions/manufacturing-execution-system"
                  className="hover:text-blue-600"
                >
          ...
          <div>
            <h4 className="font-bold text-slate-200 mb-4">Contact</h4>
            <ul className="space-y-2 text-sm text-slate-100">
              ...
              <li className="flex items-start gap-2">
                <Globe className="h-4 w-4 mt-1 text-slate-600" />
        ...
        <div className="border-t border-slate-700 font-light pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-slate-300">
          <p className="text-[12px]">
            © 2026 Digifabrix Technologies Pvt Ltd. All rights reserved.
          </p>
          <div className="flex gap-6 mt-4 md:mt-0">
            <Link href="#" className="hover:text-slate-200 text-[12px]">
              Privacy Policy
            </Link>
            <Link href="#" className="hover:text-slate-200 text-[12px]">
              Terms of Service
